...
//   //
//   //   if self.topology_type == FileTopology::Empty {
//   //     self.topology_type = FileTopology::Single;
//   //   }
//   //
...
//   //
//   //   // we need to figure out if this is creating new shards, or modifying existing shards
//   //   // that will inform us on what we are doing to self.topology
//   //
//   //   let mut shards = vec![];
...
//   //   }
//   //
//   //   self.topology.push(BlockTopology {
//   //     block: 0,
//   //     hash: vec![],
//   //     size: 0,
//   //     shards,
